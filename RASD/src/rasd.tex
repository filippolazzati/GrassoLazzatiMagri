...
\begin{longtable}{|p{3.5cm}|m{8cm}|}
 ...
 Event flow & \begin{enumerate}
    ...
    \color{red}
    TOGLIERE 6 E 7?
    Inoltre qui sembra che un farmer possa inserire i dati riguardanti la sua attività solamente al momento del raccolto, mentre secondo me avrebbe più senso se potesse inserire in ogni momento cosa ha seminato/piantato/fertilizzato/irrigato/raccolto
    \color{black}
 \end{enumerate}\\
 \hline
...
\color{red}
Da cambiare perché abbiamo detto che la password c'è già; potremmo semplicemente limitare questo use case all'inserimento dell'area (o forse anche nome cognome?)
\color{black}
...
\begin{longtable}{|p{3.5cm}|m{8cm}|}
 ...
 Exceptions & \begin{itemize}
     ...
     \item If the password is \color{red}too short \color{black}, the farmer is forced to change it.
 \end{itemize}\\
 \hline
...
\color{red}
mancano corrispondenti requirements -> da aggiungere
toglierei la verifica dell'esistenza della farm (se proprio vogliamo occuparci di questo problema potremmo dare la possibilità agli agronomist di eliminare un farmer con tutti i suoi dati se quando lo visita la prima volta si accorge che non esiste)
\color{black}
...
\color{red}
notifica visita sia in entry condition che in event flow?
specificare meglio modifiche alle visite?
\color{black}
...
\color{red}
specificare meglio le modifiche? aggiungere qui il fatto che gli agronomist possono vedere i dati dei farmer che visitano?
\color{black}
...
\begin{longtable}{|p{3.5cm}|m{8cm}|}
 ...
 Actor & SoilSensors\\
 \hline
 Entry condition & \color{red}A timer has expired.\\
 \hline \color{black}
 Event flow & \begin{enumerate}
    \item \verb|DREAM| asks the soil sensors for some data;
    \item the soil sensors answer with the data;
    \item \color{red}\verb|DREAM| stores the data in its database.\color{black}
 \end{enumerate}\\
 \hline
 ...
 \hline
 Special requirements &\begin{itemize}
     \item The sensor must answer in less than 5 seconds; \color{red} non è un requirement di dream \color{black}
...
\begin{longtable}{|p{3.5cm}|m{8cm}|}
 ...
 \hline
 Entry condition & \color{red}A timer has expired.\color{black}\\
 \hline
 Event flow & \begin{enumerate}
 ...
 Special requirements &\begin{itemize}
     ...
     \color{red} non è un requisito di dream \color{black}
     \item \verb|DREAM| must try to contact the sensor 3 times before giving up.
 \end{itemize}\\
 \hline
\end{longtable}
...
The Expert is logged in the \verb|DREAM| system.\\
 ...
 Event flow & \begin{enumerate}
    ...
    \item From the homepage, the Expert enters the "My Replies" section.
    \item \verb|DREAM| shows a list of the requests issued to the Expert, where the 
          unanswered ones are highlighted.
    \item The Expert selects from the list of requests the request issued by the Farmer.
    \item \verb|DREAM| shows the name of the Farmer, the timestamp, title and text of the request, and a form to insert the reply.
    \item The Experts fills the text input of the form.
    \item The Experts clicks on the "Send Reply" button.
    \item \verb|DREAM| sends the reply to the Farmer – that is, it associates the reply to the request of the Farmer.
    \item \verb|DREAM| shows a confirm of having sent the reply, containing the name of the Farmer, the title and the text of the request, and the text of the reply.
    ...
    \item The Farmer selects the request which the Expert has replied to.
