...
\caption{Explanation of mapping between components and functional requirements.}
 \label{comp-req mapping explanation}
    ...
    \newline\newline
    Agronomists insert feedback about their visits to the farms when confirming their daily plan, and this operation is managed by the DailyPlanService.
    \color{red}
    aggiungere interfaccia: in DailyPlanService manca interfaccia per confermare il daily plan
    anche nel class diagram si potrebbe aggiungere il feedback tra gli attributi della visita
    \color{black}\\
    \hline
