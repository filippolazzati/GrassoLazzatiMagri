...
{
    public const MAX_VISITS_IN_A_DAY = 8;
    public const MIN_VISITS_IN_A_YEAR = 2;
    public const MIN_VISITS_IN_A_MONTH_FOR_WORST_FARMERS = 1;
    public const START_WORKDAY = '08:00';
    public const BEGIN_LUNCH_BREAK = '12:30';
    public const LAST_POSSIBLE_WORK_HOUR = '19:00';
    public const WORKING_HOURS = 8;
    public const MINUTES_PER_HOUR = 60;
    public const MIN_VISIT_DURATION = 'PT15M';
