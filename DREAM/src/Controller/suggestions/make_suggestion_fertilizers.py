...
params = list()
for i in range(6):
    params.append(np.loadtxt('../src/Controller/suggestions/params-mean-std/params'+str(i)+'.csv', delimiter=','))
data_mean = np.loadtxt('../src/Controller/suggestions/params-mean-std/mean.csv', delimiter=',')
data_std = np.loadtxt('../src/Controller/suggestions/params-mean-std/std.csv', delimiter=',')
